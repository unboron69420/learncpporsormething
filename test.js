    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fs_1.promises.readFile(DB_FILE, 'utf-8')];
                case 1:
                    data = _a.sent();
...
function saveTasks() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.promises.writeFile(DB_FILE, JSON.stringify(tasks, null, 2))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var server = (0, http_1.createServer)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        parsedUrl = new url_1.URL(req.url || '', "http://".concat(req.headers.host));
        // Set CORS headers
            ...
            // POST new task
                ...
                req.on('end', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                newTask = __assign({ id: tasks.length + 1 }, JSON.parse(body_1));
                                tasks.push(newTask);
